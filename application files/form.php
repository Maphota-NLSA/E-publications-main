<?php
// Start session for potential use in authentication or error reporting
session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <form id="bibliographyForm" action="../assets/php/conn.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
